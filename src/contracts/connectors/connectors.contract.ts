...
export const connectorsEndpoints: EndpointContract[] = [
  ...
  { id: 'credentials.rotate', method: 'POST', path: `${ORG}/connections/{connectionId}/credentials/rotate`, summary: 'Rotaciona a credencial', tag: TAG, permission: 'connection.rotate_credentials', idempotent: true, optimisticConcurrency: true, requestSchema: 'RotateConnectionCredentialRequest', pathParams: ['organizationId', 'connectionId'], successStatus: 201, responseSchema: 'CredentialMetadataResponse' },
